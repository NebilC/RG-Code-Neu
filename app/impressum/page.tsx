      ...
      <section className="bg-card border-b border-border">
        <div className="container mx-auto px-4 py-16 md:py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">Angaben gemäß § 5 TMG</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-card rounded-lg border border-border p-6">
              ...
              <div className="text-muted-foreground space-y-2">
                <p>
                  <span className="text-foreground font-medium">Nummer:</span> HRB 102680
                </p>
                <p>
                  <span className="text-foreground font-medium">Registergericht:</span> Amtsgericht Darmstadt
                </p>
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg border border-border p-6">
              ...
              <div className="text-muted-foreground space-y-2">
                ...
                <p className="font-semibold text-foreground text-lg">DE348450262</p>
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg border border-border p-6">
              ...
              <p className="text-muted-foreground font-medium">021 242 0018 7</p>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg border border-border p-6 md:p-8">
            ...
            <div className="text-muted-foreground space-y-3">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+4961423306222" className="hover:text-secondary transition-colors">
                  06142 33 06 222
                </a>
              </div>
              <p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground leading-relaxed space-y-1 mb-3">
                      <p className="font-medium text-foreground">RG Rüsselsheimer Garage GmbH</p>
                      <p>Alexander-Fleming-Ring 19A</p>
                      <p>65428 Rüsselsheim</p>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-2">
                      ...
                      diese Bestimmungen gestütztes Profiling. Die jeweilige Rechtsgrundlage, auf der eine Verarbeitung
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-2">
                      ...
                      Anfrage und für den Fall von Anschluss fragen bei uns gespeichert. Diese Daten geben wir nicht
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-2">
                      ...
                      sogenannten „Shariff"-Lösung. Diese Anwendung verhindert, dass die auf unserer Website
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-2">
                      ...
                      eine direkte Verbindung zum Server des Anbieters hergestellt (Einwilligung). Sobald Sie das Plugin
                      aktivieren, erhält der jeweilige Anbieter die Information, dass Sie mit Ihrer IP-Adresse unsere
                      Seite besucht haben. Wenn Sie gleichzeitig in Ihrem jeweiligen Social-Media-Account (z.B.
                      Facebook) eingeloggt sind, kann der jeweilige Anbieter den Besuch unserer Seiten Ihrem
                      Benutzerkonto zuordnen.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      Das Aktivieren des Plugins stellt eine Einwilligung im Sinne des Art. 6 Abs. 1 lit. a DSGVO dar.
